    ...
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[750px] bg-dark-300 border-transparent">
                <form>
                    <DialogHeader>
                        <DialogTitle className={'text-white-900'}>Create new project</DialogTitle>
                    ...
                    <div className="grid gap-6 py-8">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="project-description" className={'text-gray-400'}>Project description</Label>
                            <CustomTextarea
                                className={'bg-dark-200'}
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="project-description" className={'text-gray-400'}>Target languages</Label>
                            {/*<LanguageSelector />*/}
                        </div>
                    </div>
                    <DialogFooter>
