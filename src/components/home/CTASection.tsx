            ...
            <div className="flex flex-col items-center justify-center space-y-6 text-center">
                <div className="space-y-4">
                    ...
                    <p className="mx-auto max-w-[600px] font-medium text-white-900 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                        NativeTranslate is available by invitation only. Contact
                        an administrator for access or to request an invite.
                    </p>
                </div>
                <div className="w-full max-w-sm space-y-4">
                    ...
                    <p className="text-xs text-gray-400">
                        Need an invite? Contact an system administrator.
                    </p>
                </div>
            </div>
        </div>
