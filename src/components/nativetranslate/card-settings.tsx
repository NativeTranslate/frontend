...
import { Switch } from '@/components/nativetranslate/custom-switch.tsx';
...
const CardSettingsComponent: React.FC<CardSettingsProps> = ({
    ...
    return (
        <Card className="bg-light-one dark:bg-dark-two dark:text-light-two shadow-lg border-transparent text-dark-input w-full">
            <CardHeader>
