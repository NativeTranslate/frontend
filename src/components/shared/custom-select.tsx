...
const CustomSelect: React.FC<CustomSelectProps> = ({ id, options, placeholder, onChange }) => {
    return (
        <Select onValueChange={onChange}>
            <SelectTrigger id={id} className="w-full bg-dark-300 text-gray-400 rounded-3xl border-none py-6 px-4">
