            ...
            <div className="flex flex-col h-full">
                ...
                <div className="flex-grow w-full rounded-3xl overflow-y-auto my-10">
                    ...
                    <div className="grid grid-cols-[3fr_1fr] gap-x-12 h-full">
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow className="hover:bg-transparent">
                                            <TableHead className="text-left text-primary-500 pr-14">
                                                ID
                                            </TableHead>
                        ...
                        <div className="bg-dark-300 rounded-3xl p-6 flex flex-col justify-center items-center h-full">
                            <div className="w-full max-w-lg">
                                {selected ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center h-full">
                                        ...
                                        <h1 className="text-4xl text-red-500 font-bold mt-4">
                                            No User Found
                                        </h1>
                                        <p className="text-white-900 text-lg mt-2 text-center">
                                            Oops! No user has been selected.{' '}
                                            <br />
                                            Use the sidebar to find and choose a
                                            user.
                                        </p>
                                    </div>
                                )}
