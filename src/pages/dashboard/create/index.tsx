...
const projectTypes = [
    ...
    },
    {
        id: 'private',
        name: 'Private',
        description: 'Visible only to you and the people you invite to the project.',
                ...
                <div className="flex-grow w-full bg-dark-300 rounded-3xl overflow-y-auto my-10 pb-4 md:pb-0">
                    <div className="flex flex-col mx-4 sm:mx-12 my-12">
                        ...
                        <div className="flex flex-col gap-3 sm:gap-8 mt-12">
                            ...
                            <div className={'space-y-2'}>
                                <Label htmlFor="project-name" className={'text-gray-400'}>Project identifier</Label>
                                <ProjectAddressInput baseUrl={'https://nativetranslate.ovh/dashboard/project/'}
                                                     onChange={() => {
                                                     }} />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="project-description" className={'text-gray-400'}>Project
                                    description</Label>
                                <CustomTextarea
                                    className={'bg-dark-200'}
                                            ...
                                            >
                                                <Card className="w-full bg-dark-300 border-transparent shadow-lg">
                                                    <CardContent className="flex items-center space-x-4 p-4">
                                                        <div
                                                            className="flex-shrink-0 text-foreground">{type.icon}</div>
                                                        <div>
                                                            <div
                                                                className="text-base font-semibold text-white-900">{type.name}</div>
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="project-description" className={'text-gray-400'}>Source language</Label>
                                <Select defaultValue={'English'}>
                                    ...
                                    <SelectContent>
                                        {fakeLanguages.map((language) => (
                                            <SelectItem key={language} value={language} className={'text-gray-400'}>
                                                {language}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="project-description" className={'text-gray-400'}>Target
                                    languages</Label>
                                <LanguageSelector />
                            </div>

                            <div className="space-y-2 flex justify-end">
                                <Button disabled={isSubmitting} className="bg-main-two">
