...
import {Loader2Icon, LockIcon, Mail, PartyPopperIcon, User} from "lucide-react"
		...
		<div className="bg-dark-200 min-h-screen flex items-center justify-center p-4">
			<div className="bg-dark-300 rounded-lg shadow-lg overflow-hidden flex max-w-4xl w-full">
				<div className="w-full md:w-1/2 p-8">
					...
					<h2 className="text-2xl text-white-900 font-bold mb-6">Sign Up</h2>
					<form className="space-y-4">
						...
						<div>
							<label htmlFor="invite" className="block text-sm font-medium text-gray-400 mb-1">
								Invite
							</label>
							<div className="relative">
								<Input
				...
				<FormCard text={['Welcome!', "Bievenue!", "Willkommen!", "¡Bienvenido!", "欢迎!"]}/>
			</div>
		</div>
	);
}
